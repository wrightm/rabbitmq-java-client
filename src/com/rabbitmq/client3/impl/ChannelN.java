...
import com.rabbitmq.client3.FlowListener;
...
import com.rabbitmq.client3.UnexpectedMethodError;
import com.rabbitmq.client3.impl.AMQImpl.Basic;
import com.rabbitmq.client3.impl.AMQImpl.Channel;
import com.rabbitmq.client3.impl.AMQImpl.Confirm;
 ...
 * </pre>
 */
public class ChannelN extends AMQChannel implements com.rabbitmq.client3.Channel {
    ...
    /** Public API - {@inheritDoc} */
    public com.rabbitmq.client3.AMQP.Queue.DeclareOk queueDeclare()
        throws IOException
    {
