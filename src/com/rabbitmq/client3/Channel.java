...
import com.rabbitmq.client3.AMQP.Exchange;
import com.rabbitmq.client3.AMQP.Queue;
import com.rabbitmq.client3.AMQP.Tx;
import com.rabbitmq.client3.AMQP.Basic;
import com.rabbitmq.client3.AMQP.Confirm;
import com.rabbitmq.client3.AMQP.Channel.FlowOk;
...
public interface Channel extends ShutdownNotifier {
    ...
    /**
     * Close this channel with the {@link com.rabbitmq.client3.AMQP#REPLY_SUCCESS} close code
     * and message 'OK'.
     *
    ...
    /**
     * Abort this channel with the {@link com.rabbitmq.client3.AMQP#REPLY_SUCCESS} close code
     * and message 'OK'.
     *
     ...
     * @see com.rabbitmq.client3.AMQP.Basic.Qos
    ...
    /**
     * Publish a message
     * @see com.rabbitmq.client3.AMQP.Basic.Publish
     ...
     * @see com.rabbitmq.client3.AMQP.Exchange.Declare
     * @see com.rabbitmq.client3.AMQP.Exchange.DeclareOk
    ...
    /**
     * Delete an exchange
     * @see com.rabbitmq.client3.AMQP.Exchange.Delete
     * @see com.rabbitmq.client3.AMQP.Exchange.DeleteOk
     * @param exchange the name of the exchange
     ...
     * @see com.rabbitmq.client3.AMQP.Exchange.Bind
     * @see com.rabbitmq.client3.AMQP.Exchange.BindOk
     ...
     * The name of the new queue is held in the "queue" field of the {@link com.rabbitmq.client3.AMQP.Queue.DeclareOk} result.
     * @see com.rabbitmq.client3.AMQP.Queue.Declare
     * @see com.rabbitmq.client3.AMQP.Queue.DeclareOk
     ...
     * @see com.rabbitmq.client3.AMQP.Queue.Delete
     * @see com.rabbitmq.client3.AMQP.Queue.DeleteOk
     * @param queue the name of the queue
     ...
     * @see com.rabbitmq.client3.AMQP.Queue.Bind
     * @see com.rabbitmq.client3.AMQP.Queue.BindOk
     * @param queue the name of the queue
     * @param exchange the name of the exchange
     * @param routingKey the routine key to use for the binding
     * @return a binding-confirm method if the binding was successfully created
     ...
     * @see com.rabbitmq.client3.AMQP.Queue.Unbind
     * @see com.rabbitmq.client3.AMQP.Queue.UnbindOk
     * @param queue the name of the queue
     * @param exchange the name of the exchange
     * @param routingKey the routine key to use for the binding
     ...
     * @see com.rabbitmq.client3.AMQP.Queue.Purge
     * @see com.rabbitmq.client3.AMQP.Queue.PurgeOk
     * @param queue the name of the queue
    ...
    /**
     * Retrieve a message from a queue using {@link com.rabbitmq.client3.AMQP.Basic.Get}
     * @see com.rabbitmq.client3.AMQP.Basic.Get
     * @see com.rabbitmq.client3.AMQP.Basic.GetOk
     * @see com.rabbitmq.client3.AMQP.Basic.GetEmpty
     * @param queue the name of the queue
     ...
     * messages. Supply the deliveryTag from the {@link com.rabbitmq.client3.AMQP.Basic.GetOk}
     * or {@link com.rabbitmq.client3.AMQP.Basic.Deliver} method
     * containing the received message being acknowledged.
     * @see com.rabbitmq.client3.AMQP.Basic.Ack
     * @param deliveryTag the tag from the received {@link com.rabbitmq.client3.AMQP.Basic.GetOk} or {@link com.rabbitmq.client3.AMQP.Basic.Deliver}
     ...
     *
     * Supply the <code>deliveryTag</code> from the {@link com.rabbitmq.client3.AMQP.Basic.GetOk}
     * or {@link com.rabbitmq.client3.AMQP.Basic.GetOk} method containing the message to be rejected.
     * @see com.rabbitmq.client3.AMQP.Basic.Nack
     * @param deliveryTag the tag from the received {@link com.rabbitmq.client3.AMQP.Basic.GetOk} or {@link com.rabbitmq.client3.AMQP.Basic.Deliver}
    ...
    /**
     * Reject a message. Supply the deliveryTag from the {@link com.rabbitmq.client3.AMQP.Basic.GetOk}
     * or {@link com.rabbitmq.client3.AMQP.Basic.Deliver} method
     * containing the received message being rejected.
     * @see com.rabbitmq.client3.AMQP.Basic.Reject
     * @param deliveryTag the tag from the received {@link com.rabbitmq.client3.AMQP.Basic.GetOk} or {@link com.rabbitmq.client3.AMQP.Basic.Deliver}
     ...
     * @throws java.io.IOException if an error is encountered
     * @see com.rabbitmq.client3.AMQP.Basic.Consume
     * @see com.rabbitmq.client3.AMQP.Basic.ConsumeOk
     * @see #basicAck
     ...
     * @see com.rabbitmq.client3.AMQP.Basic.Cancel
     * @see com.rabbitmq.client3.AMQP.Basic.CancelOk
     */
     ...
     * @see com.rabbitmq.client3.AMQP.Tx.Select
     * @see com.rabbitmq.client3.AMQP.Tx.SelectOk
     ...
     * @see com.rabbitmq.client3.AMQP.Tx.Commit
     * @see com.rabbitmq.client3.AMQP.Tx.CommitOk
     ...
     * @see com.rabbitmq.client3.AMQP.Tx.Rollback
     * @see com.rabbitmq.client3.AMQP.Tx.RollbackOk
     ...
     * @see com.rabbitmq.client3.AMQP.Confirm.Select
     * @throws java.io.IOException if an error is encountered
     */
